...
--
-- Table structure for table `RestaurantRatingTable`
--
...
--
LOCK TABLES `RestaurantRatingTable` WRITE;
INSERT INTO `RestaurantRatingTable` (`RestaurantRating_ID`,`Restaurant_ID`,`Rating`)
VALUES
  (1,1,4),
  (2,2,4),
  (3,3,2),
...
--
-- Table structure for table `DriverRatingTable`
--
